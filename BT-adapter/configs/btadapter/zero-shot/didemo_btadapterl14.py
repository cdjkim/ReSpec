...
# customize #
#############
data_root = '/gallery_mfa/data/video/didemo/DiDeMo'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        # ann_file='didemo_ret_train.json',
        ann_file='dj_train.json',
        data_root=data_root,
        data_prefix=dict(video='DiDeMo_Videos'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        # ann_file='didemo_ret_test.json',
        ann_file='dj_test.json',
        data_root=data_root,
        data_prefix=dict(video='DiDeMo_Videos'),
