...
# customize #
#############
data_root    = '/gallery_mfa/data/video/activitynet/rawframes'
val_ann_file = '/gallery_mfa/data/video/activitynet/anet_ret_val_1_valid.json'
num_file     = '/gallery_mfa/data/video/activitynet/anet_ret_val_1_num_frames.json'

_base_       = '../../_base_/default_runtime.py'
dataset_type = 'ActivityNetRetDataset'
custom_bs    = 4
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        num_file=num_file,
        data_root=data_root,
        data_prefix=dict(video='rawframes'),
