...
train_data_type  = 'WebvidDataset_source'
# TODO update below according to webvid root"
train_data_root  = '/gallery_mfa/sangwoo.moon/data/video/webvid/resized_videos'
train_ann_file   = '/gallery_mfa/sangwoo.moon/data/video/webvid/results_2M_train_valid.pkl'
val_dataset_type = 'MsrvttDataset'
val_data_root    = '/gallery_mfa/sangwoo.moon/data/video/MSRVTT'
...
train_dataloader = dict(
    batch_size=52,
    num_workers=8, # XXX SW change worker to 8
...
default_hooks = dict(checkpoint=dict(type='printBest_CheckpointHook', interval=0, save_best='auto', rule='greater'))
