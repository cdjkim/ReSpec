...
# TODO 
train_data_root  = '/gallery_mfa/sangwoo.moon/data/video/videocc3m/clips_final'
train_ann_file   = '/gallery_mfa/sangwoo.moon/data/video/videocc3m/video_cc_3m_final.csv'
val_dataset_type = 'MsrvttDataset'
val_data_root    = '/gallery_mfa/sangwoo.moon/data/video/MSRVTT'

train_data_type  = 'CC3MDataset'
